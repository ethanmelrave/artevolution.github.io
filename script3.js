...
digitalart: [
{ title: "Blue, Red, and Orange", img: "digiart/BlueRedAndOrange.jpeg", artist: "Edwynne Raschieka H. Janda", price: "$300", description: "A trio that are once more than friends—a found family.", medium: "ibisPaintX" },
    { title: "Chiki the Mouse", img: "digiart/Chiki.jpeg", artist: "Edwynne Raschieka H. Janda", price: "$760", description: "An illustration from a work titled, 'Ang Makukulay na Liham ni Chiki.", medium: "ibisPaintX" },
    { title: "Galactic Siren", img: "digiart/GalacticSiren.jpeg", artist: "Edwynne Raschieka H. Janda", price: "$250", description: "Celestial being who's adorned with stars for pearls and the comets for it's fins.", medium: "Artbook (IOS)" },
    { title: "The Beautiful, Haitia Snow", img: "digiart/HaitiaSnow.jpeg", artist: "Edwynne Raschieka H. Janda", price: "$1000", description: "An original character from a good friend and the world they are making.", medium: "ibisPaintX" },
    { title: "Muse of a Lifetime", img: "digiart/MuseOfALifetime.jpeg", artist: "Edwynne Raschieka H. Janda", price: "$680", description: "Another original character portrait, dedicated to a younger friend.", medium: "ibisPaintX" }
    ],
graphicdesign: [
